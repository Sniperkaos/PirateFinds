...
public class OldSoulAddition extends AdvancedEffect {
	public OldSoulAddition() {
		super(PirateFinds.getThisPlugin(), "PFSOUL_ADD");
	 ...
	 public boolean executeEffect(ExecutionTask task, LivingEntity entity, String[] args) {
		...
		if(types.contains("ATTACK") || types.contains("ATTACK_MOB")) {
			...
			if(attacker instanceof Player) {
				...
				soul.addSouls(Integer.valueOf(args[0]));
			}
